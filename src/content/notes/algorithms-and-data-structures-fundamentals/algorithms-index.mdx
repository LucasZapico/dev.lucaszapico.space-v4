...
- [LeetCode Patterns - github](https://github.com/seanprashad/leetcode-patterns)

### Courses 

[Algorithm Patterns for Coding Interview(leetcode) - Kantan Coding](https://www.youtube.com/watch?v=cpgAULF6Vpw&list=PL7g1jYj15RUOjoeZAJsWjwV8XUo9r0hwc&pp=iAQB)

<Box mb={6}>
	<YouTube youTubeId="cpgAULF6Vpw"></YouTube>
</Box>
